      ...
      <div className="flex divide-x">
        <div className="w-full flex-col divide-y sm:w-1/2">
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col space-y-2 px-6 pb-6">
              <h2 className="flex items-center text-3xl">{newFeaturePost.title}</h2>
              <p className="text-lg">{newFeaturePost.description}</p>
              <Link
          ...
          <div className="px-20">
            <div className="flex flex-col items-center justify-center space-y-12 border-x py-20">
              ...
              <button className="bg-surface-component px-6 py-2 text-lg text-text-invert">
                {t('downloadNow')}
              </button>
            </div>
          </div>
        ...
        <div className="w-full flex-col divide-y sm:w-1/2">
          ...
          <div className="flex flex-col items-center space-y-6 p-6 text-center">
            ...
            <p className="text-lg">{t('welcomeNewFeatureIdea')}</p>
          </div>
        </div>
      </div>
    </>
      ...
      <Link href={`/blog/${post.slug.current}`}>
        <div className={`flex space-x-12 p-6`}>
          ...
          <div className="my-auto">
            ...
            <h3 className="text-2xl capitalize">{post.title}</h3>
          </div>
        </div>
      </Link>
    </div>
